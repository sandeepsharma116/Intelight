...
public class ColorPaletteView extends View {
    ...
    public ColorPaletteView(Context c, int color) {
        super(c);
        centerColor=color;
        mColors = new int[]{
        ...
        mCenterPaint.setStrokeWidth(185);
    }
    ...
    protected void onDraw(Canvas canvas) {
        float r = (CENTER_X - mPaint.getStrokeWidth() * 0.5f)*0.6f;
        ...
        if (mTrackingCenter) {
            ...
            Log.d("Color", Integer.toString(c));
        ...
        EventBus.getDefault().post(centerColor);
    }
